...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001349334651').split()]
...
SUPPORT_CHAT = environ.get('1410065122', '@My_Name_is_developer')
...
MOVIE_GROUP_USERNAME = environ.get('MOVIE_GROUP_USERNAME', "https://t.me/+oMtVUAX4PDxlYmNl") #[ without @ ]
